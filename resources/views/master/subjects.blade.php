                    ...
                    <table id="subject" class="table table-bordered table-stripped">
                        ...
                        @foreach($subjects as $subject)
                            <tr>
                                <td>{{ $subject->name }}</td>
                                <td class="text-right">
                                    <a href="{{ route('delete-subject',['id' => $subject->id]) }}" class="btn btn-danger flat btn-sm">DELETE</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
...
@section('page-header')
    <div class="box box-default flat">
        <div class="box-header page-head">
            <h3 class="box-title display--block">LIST OF ALL SUBJECT <button type="button" class="btn btn-info btn-sm flat pull-right" data-toggle="modal" data-target="#createSubject">CREATE NEW</button></h3>
        </div>
    </div>
